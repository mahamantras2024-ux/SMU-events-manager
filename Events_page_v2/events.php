...
<div class="container py-4">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <div class="navbar-nav" id="navitems">
      ...
      <a class="nav-item nav-link ula nvit" href="chat.php">Chats</a>
...
<?php
  ...
  $events_arr = array_map(function ($event) {
    ...
    return [
      ...
      'details' => $event->getDetails(), // CRITICAL FIX: Added 'details'
  ...
  $user_events_arr = array_map(function ($events) {
    ...
    return [
        ...
        'details' => $events->getDetails(), // CRITICAL FIX: Added 'details'
...
function cardTemplate(e, isSaved, hasClashAgainstOthers){
  ...
  // Define encoded variables for clean use in the template literal

  const encodedTitle = JSON.stringify(e.title);

  const encodedDetails = JSON.stringify(e.details || '');
  ...
  <div class="event-body">
    ...
    <div class="event-actions d-flex gap-2 flex-wrap">
      ...
      <button class="btn btn-outline-secondary btn-sm"
              ...
              onclick='showDetails(${encodedTitle}, ${encodedDetails})'>
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="detailsModalBody" class="text-wrap"></div>
...
function showDetails(title, details){
  ...
  document.getElementById('detailsModalTitle').textContent = title || 'Event details';

  var safe = escapeHtml(details || '').replace(/\n/g,'<br>');

  document.getElementById('detailsModalBody').innerHTML = safe && safe.trim().length ? safe : '<span class="text-muted">No additional details provided.</span>';

  // Use getOrCreateInstance for Bootstrap 5
